        ...
        <div className='px-2 lg:px-7 pt-5'>
            <div className='w-full p-4 bg-[#6a5fdf] rounded-md '>
                <div className='flex justify-between items-center'>
                    <select onChange={(e) => setParpage(parseInt(e.target.value))} className='px-4 py-2 hover:border-indigo-500
                ...
                <div className='relative mt-5 overflow-x-auto'>
                    <div className='w-full text-sm text-left [#dod2d6]'>
                        <div className='text-sm text-[#d0d2d6] uppercase border-b border-slate-700'>
                            <div className='flex justify-between items-center'>
                                <div className='py-3 w-[25%] font-bold'>Order Id</div>
                                <div className='py-3 w-[18%] font-bold'>Price</div>
                                <div className='py-3 w-[13%] font-bold'>Payment Status</div>
                        ...
                        </div>
        {
         ...
         <div className='py-3 w-[25%] font-medium whitespace-nowrap'>#{o._id}</div>
                   ...
                   
            {
                ...
                <div className='py-3 w-[13%] font-medium'>Rp.{so.price}</div>
