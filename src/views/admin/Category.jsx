                        ...
                        <tbody> 
                            {
                                ...
                                <img className='w-[50px] h-[50px]' src={d.image} alt="" />
                                </td>
                            ...
                            lg:rounded-md text-[#d0d2d6]'>
                               ...
                               <form onSubmit={addOrUpdateCategory}>
                                <div className='flex flex-col w-full gap-1 mb-3'>
                                    ...
                                    <input value={state.name} onChange={(e)=>setState({...state,name : e.target.value})} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#fcfcfc]
                                    border border-slate-700 rounded-md text-[#d0d2d6]' type="text" id='name' name='category_name' placeholder='Category Name'/>

                                </div>
                                <div>
                                    <label className=' flex justify-center items-center flex-col h-[238px] cursor-pointer
                                    border border-dashed hover:border-green-500 w-full border-[#d0d2d6]'
                                    htmlFor="image">
                                        {
                                    ...
                                    <div className='mt-3'>
                                    <button disabled={loader ? true : false} className='bg-green-800 w-full hover:shadow-green-300/50
