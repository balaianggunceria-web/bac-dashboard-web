...
const SellerDetails = () => {
  ...
  seller?.image ? (
    <img
      ...
      src={seller.image.startsWith('http') ? seller.image : `http://localhost:3000/${seller.image}`}
      alt={seller.name}
    />
  ) : (
    <span>Image Not Uploaded</span>
                ...
                <div>
                    <form onSubmit={submit}>
                        ...
                        <select value={status} onChange={(e) => setStatus(e.target.value)} className='px-4 py-2 hover:border-indigo-500
                        ...
                        hover:shadow-md text-white rounded-md px-7 py-2'>Submit</button>
                        </div>
                    </form>
                </div>
