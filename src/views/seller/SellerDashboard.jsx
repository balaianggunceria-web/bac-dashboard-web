...
const SellerDashboard = () => {
    ...
    const state ={
        series : [
            {
                name : "Orders",
                data : [23,34,45,56,76,34,23,76,87,78,34,35]
            },
            {
                name : "Revenue",
                data : [67,39,45,56,90,56,23,56,87,78,45,67]
            },
            {
                name : "Sales",
                data : [34,39,45,56,80,56,23,56,90,78,90,88]
            },
        ],
        options: {
            color: ['#181ee8', '#181ee8'],
            ...
            xaxis : {
                categories : ['Jan', 'Feb', 'Mar', 'Apl', 'Mei', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec' ]
            },
            legend : {
                position : 'top'
            },
            ...
            <div className='w-full grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-7'>
                ...
                bg-[#fae8e8] rounded-md gap-3'>
                    ...
                    <div className='flex flex-col justify-start items-start text-[#5c5a5a]'>
                        <h2 className='text-2xl font-bold'>Rp.{totalSale}</h2>
                ...
                <div className='w-full lg:w-5/12 lg:pl-4 mt-6 lg:mt-0'>
                    <div className='w-full bg-[#6a5fdf] p-4 rounded-md text-[#d0d2d6]'>
                        <div className='flex justify-between items-center'>
                            <h2 className='font-semibold text-lg text-[#d0d2d6] pd-3'>Customer Message</h2>
                        ...
                        <tbody>
                            {
                                ...
                                <td scope='row' className='py-3 px-4 font-medium whitespace-nowrap'>Rp.{d.price}</td>
