    ...
    const {userInfo } = useSelector(state => state.auth)
            ...
            return (
                <div className='px-2 lg:px-7 pt-5'>
                    <h1 className='text-[#000] font-semibold text-lg mb-3'>Orders</h1>
                                ...
                                <tbody>
                                    {
                                        ...
                                        <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>Rp.{d.price}</td>
                                        ...
                                        <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'>
                                            <div className='flex justify-start items-center gap-4'>
                                             ...
                                             <Link to={`/seller/dashboard/orders/details/${d._id}`} className='p-[6px] bg-green-500 rounded 
